import spectrecore from '@spectre/core-lib';
import { SpectreAPI } from 'wallet/apiHelpers';

export type Network = 'spectre' | 'spectredev' | 'spectrereg' | 'spectretest' | 'spectresim';
export type bytes = string;//base84 string

export * from './rpc';
import {IRPC, RPC} from './rpc';
import { SpectreAPI } from './apiHelpers';
